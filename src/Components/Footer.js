...
function Footer({ footer }) {
    ...
    const button = <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M9.4 18 8 16.6l4.6-4.6L8 7.4 9.4 6l6 6Z" /></svg>
    ...
    return (
        <>
            <div className='preFooter'>
                <div>
                    {repeatIcon}
                    <p><b>Hassle Free Replacement</b><br />10 days easy replacement poilcy for mi.com</p>
                </div>
                <div>
                    {shieldIcon}
                    <p><b>100% secure payments</b><br />We support cards,EMIs,Wallet,COD</p>
                </div>
                <div>
                    {mapIcon}
            ...
            <div className='preFooter_2'>
                ...
                <div>
                    {youtubeIcon}{facebookIcon}{twitterIcon}{instagramIcon}
                </div>
            </div>
